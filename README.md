...
아기옷부터 가족옷까지, 소재를 축으로 한 브랜드 **품(POOM)** 의 프리런치 사이트.
...
Konny를 참고하되 **같은 길로 가지 않습니다.**

| | Konny | 품 |
|---|---|---|
| 파는 방식 | 감성 · 편의 | 증거 · 규격 |
| 이미지 | 풀블리드 라이프스타일 사진 | 기술 도면 일러스트 |
| 카피 | 대화체 · 이모지 | 평서문 · 숫자 |
| 색 | 파스텔 다색 | 뉴트럴 + 액센트 1 |
| 신뢰 근거 | 누적 판매·후기 수 | 인증번호 · 세탁 실측표 |

두 번째 축은 **얼룩**입니다. 촉감과 방오는 물리적으로 상충하므로
하나의 원단으로 둘 다 하지 않고, 라인을 나눕니다.
피부에 닿는 Sleep·Base는 가공 없음, 위에 걸치는 Play만 불소 없는 발수(C0).

## 아직 확정 아닌 것

- **브랜드명** — 품/POOM은 후보 1순위. 확정은 D24 (상표 검색 후)
- **원단** — 전부 후보 단계. 스와치 수령 후 실측으로 교체 (D31)
- **가격** — 원가 계산(D28) 후 갱신
- **사진** — 전부 일러스트 플레이스홀더. 촬영은 D75–81
- **세탁·얼룩 테스트표** — 빈칸. D31 이후 직접 빨아서 채움

90일 실행 플랜:
https://claude.ai/code/artifact/47b3aaee-f039-48b2-8c71-03d4caba297e
