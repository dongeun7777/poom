...
(function () {
  ...
  var CATALOG = {
    'sleep-set': {
      ...
      fabric: 'Cotton 95 / Spandex 5', gsm: 180, yarn: '코마사 30수 인터록',
      finish: '가공 없음',
      wipe: { grade: '보통', note: '피부에 닿는 옷이라 발수 가공을 하지 않습니다. 대신 조직을 인터록으로 짜서 얼룩이 섬유 속으로 덜 파고듭니다.' },
    ...
    'base-inner': {
      ...
      desc: '재구매가 일어나는 자리라 가장 오래 검증한 원단만 씁니다. 목 뒤 라벨은 프린트, 솔기는 플랫록. 아기 보디수트와 어른 이너가 같은 원단이에요.',
      fabric: 'Cotton 100', gsm: 160, yarn: '코마사 40수',
      finish: '가공 없음',
      wipe: { grade: '낮음', note: '흡수가 잘 되는 만큼 얼룩도 잘 뱁니다. 속옷이라 이건 바꾸지 않습니다 — 대신 겉에 스목을 입히는 쪽을 권합니다.' },
    ...
    'knit-out': {
      ...
      finish: '가공 없음',
      wipe: { grade: '보통', note: '울에 남아 있는 유지 성분 덕에 물 얼룩은 잠깐 버팁니다. 다만 바로 닦아내야 하고, 세탁은 손세탁입니다.' },
    ...
    'play-smock': {
      ...
      fabric: 'Recycled Poly 100', gsm: 90, yarn: '립스톱 · 불소 없는 발수',
      finish: 'PFC-free 발수 (C0)',
      wipe: { grade: '높음', note: '물 기반 얼룩은 표면에 맺혀 헹구면 떨어집니다. 기름 얼룩은 주방세제 한 방울로 문질러 주세요. 발수력은 세탁 30회쯤부터 약해집니다.' },
